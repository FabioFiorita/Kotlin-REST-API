...
import br.com.fabiofiorita.restapi.model.Role
...
class TopicoControllerTest: DatabaseContainerConfiguration() {
    ...
    companion object {
        ...
        private const val RECURSO_ID = RECURSO.plus("/{id}")
    }
    ...
    private fun gerarToken(): String? {
        ...
        return jwtUtil.generateToken("joao@email.com", authorities)
    }
